...
import com.github.ixanadu13.annotation.processor.shade.lombok.AST;
import com.github.ixanadu13.annotation.processor.shade.lombok.CleanupRegistry;
import com.github.ixanadu13.annotation.processor.shade.lombok.CleanupTask;
...
public class JavacAST extends AST<JavacAST, JavacNode, JCTree> {
    ...
    public static JavacAST instance(JavacProcessingEnvironment javacProcessingEnv, JCCompilationUnit unit){
        Messager messager = javacProcessingEnv.getMessager();
        com.sun.tools.javac.util.Context context = javacProcessingEnv.getContext();
        JavacAST.ErrorLog errorLog = JavacAST.ErrorLog.create(messager, context);
        return new JavacAST(errorLog,context,unit,new CleanupRegistry());
    }
